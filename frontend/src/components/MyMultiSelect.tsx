                        ...
                        {selectedValues.length > 0 ? (
                            <div className="flex justify-between items-center w-full">
                                    ...
                                    {selectedValues.slice(0, maxCount).map((value) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {option?.nombre}
                                                <XCircle
                                                    className="ml-2 h-4 w-4 text-red-700 cursor-pointer"
                                                    onClick={(event) => {
                                ...
                                <div className="flex items-center justify-between">
                                    <XIcon
                                        className="h-4 mx-2 cursor-pointer text-red-700"
                                        onClick={(event) => {
                                            event.stopPropagation();
                                            handleClear();
                                        }}
                                    ...
                                    <Separator
                                        ...
                                        className="flex min-h-6 h-full bg-gray-600 font-bold"
                                    />
                            ...
                            <div className="flex items-center justify-between w-full mx-auto">
                                <span className="text-sm text-gray-800 mx-3">
                                    {placeholder}
                                </span>
                                <ChevronDown className="h-4 cursor-pointer text-gray-800 mx-2" />
                            </div>
                        )}
                    </Button>
                </PopoverTrigger>
