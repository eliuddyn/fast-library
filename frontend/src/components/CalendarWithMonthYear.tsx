    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                weekday: "text-blue-900 w-8 font-semibold text-sm capitalize",
            ...
            components={{
                ...
                CaptionLabel: ({ children }) => (
                    <Button
                        className="h-7 w-full truncate text-sm font-bold text-blue-900 capitalize"
                        variant="ghost"
                        size="sm"
                        onClick={() =>
                                    ...
                                    (_, i) => {
                                        ...
                                        return (
                                            <Button
                                                key={i}
                                                className={cn(
                                                    "h-7 w-full text-sm font-semibold text-foreground",
